...
relatedConditions: [thyroid, hormone-imbalance]
testingPanels:
  - "Adrenal cortisol pattern (DUTCH or salivary)"
...
You are not broken. Your battery is being drained somewhere you haven't looked.
...
Standard fatigue workups usually mean a CBC, a TSH, maybe an iron and a vitamin D. If those fall inside reference range, you're told you're fine.

The problem: reference ranges are wide, and "normal" is not always "optimal." A TSH at the high end of normal can still mean a sluggish thyroid. Ferritin at 30 is technically not anemic but is functionally low for energy. A flat cortisol curve looks fine on a single morning blood draw — but maps a clear pattern of adrenal dysregulation when tested across the day.
...
When we run the full panel, we frequently find adrenal patterns, thyroid conversion issues, nutrient gaps, or food triggers that a basic CBC could never surface.

## The 3 T's Behind Fatigue
...
After we have your results, we build a personalized plan. For fatigue patients, that often involves:

- **Chiropractic care** to support nervous system regulation and recovery capacity
- **Targeted nutrition** to stabilize blood sugar and fill nutrient gaps
- **Supplementation** for adrenal support, thyroid cofactors, and mitochondrial inputs
