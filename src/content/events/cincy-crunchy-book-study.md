...
**Last Thursday of every month · 7:30 PM – 9:00 PM**
...
- Zero pressure to talk if you'd rather listen

## Past Reads and Themes We've Covered

We've worked through books on:
- Hormone health and the menstrual cycle
- Kids' immune systems and the modern food environment
- Gut health and the brain-gut axis
- Functional medicine basics
- Sleep, stress, and the nervous system

You don't need to have read any of them to join now. Each book stands alone.

## How to RSVP

The meeting is free and open. We just like to know who's coming so we have enough seating and snacks. RSVP via the [contact page](/contact) or call the clinic at **(283) 223-8376**.
